...
const NavBar = () => {
  ...
  return (
    <div className=" text-slate-300 h-screen bg-black flex flex-col w-[15%]">
      ...
      <nav className="justify-between flex h-full p-2 pr-0 flex-col">
        <div className="flex flex-col gap-1">
          <Link
            className={`py-4 ${
              pathname === "/" ? "bg-accentHome font-semibold" : ""
          ...
          {/* <Link
        className={`py-4 px-5 gap-2 duration-100 flex items-center rounded-l-full hover:font-semibold"
        href={"/"}
		>
        Discover
	</Link> */}
